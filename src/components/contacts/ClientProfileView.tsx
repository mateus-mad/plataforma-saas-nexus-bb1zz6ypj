...
export default function ClientProfileView({ onOpenChange, onEdit, companyData, type }: any) {
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 flex flex-col md:flex-row items-center gap-5">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-sm text-blue-800/80 mt-1 max-w-xl">
                    Gere contratos, propostas e aditivos automaticamente usando os dados cadastrais
                    do cliente. A integração completa com assinaturas digitais estará disponível em
                    breve.
                  </p>
                </div>
